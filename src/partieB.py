...
def b1_plot_2_graphiques(res_b1: dict):
    ...
    plt.xlabel("Risque (Écart-type annuel)")
    plt.ylabel("Rendement attendu annuel (%)")
    plt.title("Q4 — Comparaison : point médian de frontière sans vente à découvert (Partie A vs bootstrap)")
    plt.legend()
    plt.grid(True)
    plt.show()
    ...
    plt.xlim(0, 60)
    plt.ylim(0, 120)
    plt.title("Q5 — Avec actif sans risque et sans vente à découvert : point médian (Partie A vs bootstrap)")
    plt.legend()
    plt.grid(True)
    plt.show()
    ...
    # =========================
    plt.figure(figsize=(10, 6))
    plt.plot(q4_sig_curve, q4_mu_curve, linewidth=2, linestyle="--", label="Frontière efficiente sans vente à découvert — Partie A")
    ...
    plt.xlabel("Risque (Écart-type annuel)")
    plt.ylabel("Rendement attendu annuel (%)")
    plt.title("Q6 — Comparaison : portefeuille tangent sans vente à découvert (Partie A vs bootstrap)")
    plt.legend()
    plt.grid(True)
    plt.show()
